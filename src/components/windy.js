...
var Windy = function (params) {
  ...
  var animate = function (bounds, field) {
    ...
    console.log("params=>", params.canvas);
    ...
    (function frame() {
      try {
        windy.timer = setTimeout(function () {
          ...
          window.setTimeout(frame, 1000 / 20);
          evolve();
          draw();
        }, 1000 / FRAME_RATE);
      } catch (e) {
  ...
  var start = function (bounds, width, height, extent) {
    var mapBounds = {
      south: 0.014615941459045878,
      north: 1.119629452387263,
      east: 0.010331803755982182,
      west: -3.468736623167727,
      width: 1134,
      height: 475,
    };
