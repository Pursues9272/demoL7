define([
  ...
  var RL = declare([Layer], {
    ...
    _setMap: function (map, container) {
      ...
      var element = (this._element = domConstruct.create(
        "canvas",
        {
          id: "canvas",
          width: map.width + "px",
      ...
      this._connects = [];
      this._connects.push(
        connect.connect(map, "onPan", this, this._panHandler)
      );
      this._connects.push(
        connect.connect(map, "onExtentChange", this, this._extentChangeHandler)
      );
      this._connects.push(
        connect.connect(map, "onZoomStart", this, this.clear)
      );
      this._connects.push(
        connect.connect(
          this,
